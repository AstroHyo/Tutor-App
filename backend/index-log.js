...
app.post('/TTS', async function (req, res) {
  ...
  let tutorText = req.body

  let bufferData = await quickStart(tutorText);
...
async function quickStart(tutorText) {
  // The text to synthesize
  const text = tutorText;
...
//유저 목소리 녹음하여 whisper로 text 변환하는 메소드
