...
app.post('/getFeedback', async function (req, res) {
  ...
  let messages = [
    {role: "system", content: "너는 매우 훌륭한 영어 회화 튜터야. 앞으로 내가 너에게 보내줄 대화 내용은 너가 나의 영어 회화 튜터로써 나와 대화한 스크립트야. 그 내용에서 내가 틀렸던 문법, 자연스럽지 않은 문장에 대해 피드백을 주고, 내가 너무 많이 쓴 단어가 있으면 그 단어를 대체할 수 있는 좋은 단어를 추천해줘. 이 피드백 내용들을 알아보기 쉽게 이 HTML 양식에 맞게 정리해서 보내줘. ```html <div className='Feedback'> <h2 id='tutoreal-'>TutoReal 피드백이 도착했어요!</h2>\n<hr>\n<h3 id='1-'>1. 문법 교정</h3>\n<ul>\n<li>[잘못된 문법] : [올바른 문법]</li>\n</ul>\n<h3 id='2-'>2. 자연스럽지 않은 문장</h3>\n<ul>\n<li>[자연스럽지 않은 문장] : [자연스러운 표현]</li>\n</ul>\n<h3 id='3-'>3. 단어 대체 제안</h3>\n<ul>\n<li>[대체 가능한 단어] : [추천하는 단어]</li>\n</ul>\n<hr>\n<h3 id='-'>추가 설명</h3>\n<p>[피드백에 대한 추가 설명 작성]</p></div>```"},
    {role: "user", content: "너는 매우 훌륭한 영어 회화 튜터야. 앞으로 내가 너에게 보내줄 대화 내용은 너가 나의 영어 회화 튜터로써 나와 대화한 스크립트야. 그 내용에서 내가 틀렸던 문법, 자연스럽지 않은 문장에 대해 피드백을 주고, 내가 너무 많이 쓴 단어가 있으면 그 단어를 대체할 수 있는 좋은 단어를 추천해줘. 이 피드백 내용들을 알아보기 쉽게 이 HTML 양식에 맞게 정리해서 보내줘. ```html <div className='Feedback'> <h2 id='tutoreal-'>TutoReal 피드백이 도착했어요!</h2>\n<hr>\n<h3 id='1-'>1. 문법 교정</h3>\n<ul>\n<li>[잘못된 문법] : [올바른 문법]</li>\n</ul>\n<h3 id='2-'>2. 자연스럽지 않은 문장</h3>\n<ul>\n<li>[자연스럽지 않은 문장] : [자연스러운 표현]</li>\n</ul>\n<h3 id='3-'>3. 단어 대체 제안</h3>\n<ul>\n<li>[대체 가능한 단어] : [추천하는 단어]</li>\n</ul>\n<hr>\n<h3 id='-'>추가 설명</h3>\n<p>[피드백에 대한 추가 설명 작성]</p></div>``` 이제 내가 너한테 대화 스크립트를 보내줄게. 기다려봐."},
